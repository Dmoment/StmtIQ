class DocumentShare < ApplicationRecord
  ...
  validates :shared_with_email, uniqueness: { scope: :document_id, message: "already has access to this document" }
  ...
  def share_url
    Rails.application.routes.url_helpers.shared_document_url(access_token: access_token)
